    ...
    <div class="banner">
        <div class="banner-inner">
            ...
            <div class="banner-btns">
                <a href="/revhub/eventos.php" class="btn">
                    <i class="fa-regular fa-calendar"></i> Ver eventos
                </a>
    ...
    <div class="contenedor">
        ...
        <div class="eventos-grid">
            ...
            $resultado = mysqli_query($conexion,
                "SELECT * FROM eventos WHERE fecha >= CURDATE() ORDER BY fecha ASC LIMIT 3"
            );
            ...
            ?>
                <p class="sin-resultados">No hay eventos disponibles.</p>
            <?php endif; ?>
        </div>
    </div>
</main>
